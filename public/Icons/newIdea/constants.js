...
regularIcons[FRONT_LIGHT_ICON_OPTION][ICON_VIEWBOX_ATTRIBUTE] =  '0 0 24 24'
...
ICON_ATTRIBUTES.push({
    ...
    defaultValue : regularIcons[ICON_DEFAULT],
    proccessValue: (value) =>  {
        if (regularIcons.hasOwnProperty(value)) return regularIcons[value]
        else if (animatedIcons.hasOwnProperty(value)) return animatedIcons[value]
    }
})
