export default class SvgMail extends HTMLElement {
                constructor() 
                {
                    super();
                }
...
if (this.getAttribute('color'))
{
  colorFill = this.getAttribute('color')
            ...
            var customElementName = 'mail-icon'
            customElements.define(customElementName, class extends SvgMail {});
            export const MAIL_ICON = customElementName;
