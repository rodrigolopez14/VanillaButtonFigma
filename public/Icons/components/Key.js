export default class SvgKey extends HTMLElement {
                constructor() 
                {
                    super();
                }
...
if (this.getAttribute('color'))
{
  colorFill = this.getAttribute('color')
            ...
            var customElementName = 'key-icon'
            customElements.define(customElementName, class extends SvgKey {});
            export const KEY_ICON = customElementName;
