export default class SvgConnectivity extends HTMLElement {
    constructor() 
    {
        super();
    }
...
var customElementName = "connectivity-icon"
customElements.define(customElementName, class extends SvgConnectivity {});

export const CONNECTIVITY_ICON = customElementName;