...
import {SIZE_ATTRIBUTE,
    COLOR_ATTRIBUTE,
    POSITION_ATTRIBUTE,
    TEXT_CONTAINER} from "../constants.js"
import {LARGE_OPTION,
    MEDIUM_OPTION,
    BLACK_OPTION,
    WHITE_OPTION,  
    CENTER_OPTION} from "../constants.js"
...
Style1Path[POSITION_ATTRIBUTE] = CENTER_OPTION;
...
centerButtonPill.push(style1Wrapper)
...
Style2Path[POSITION_ATTRIBUTE] = CENTER_OPTION;
...
centerButtonPill.push(style2Wrapper)
...
Style3Path[POSITION_ATTRIBUTE] = CENTER_OPTION;
...
centerButtonPill.push(style3Wrapper)
...
Style4Path[POSITION_ATTRIBUTE] = CENTER_OPTION;
...
centerButtonPill.push(style4Wrapper)

export  {centerButtonPill};